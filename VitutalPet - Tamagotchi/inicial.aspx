...
<body runat="server" id="background" style="background-color: #ffd700;">
    <form id="form1" runat="server">
        <div class="container">
            <br />
            <asp:Label  id="bemvindo"  runat="server" Font-Names="Arial Black" Font-Size="20px" />
            ...
            <br />
            <asp:Label runat="server" Text="" ID="personagem" Font-Names="Arial Black" Font-Size="20px" />            
            </div>
